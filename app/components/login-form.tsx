        ...
        <div className={cn("flex flex-col gap-6", className)} {...props}>
            <Card className="overflow-hidden p-0">
                <CardContent className="grid p-0 md:grid-cols-2 relative">
                        ...
                        <div className="flex flex-col gap-6 min-h-[450px]">
                            <div className="flex flex-col items-center text-center">
                                ...
                                <p className="text-muted-foreground text-balance">
                                    {registerMode
                                        ? "Register for your Intelli-Exo account"
                                        : "Login to your Intelli-Exo account"}
                                </p>
                            </div>
                    ...
                    <div className={`w-full p-6 flex justify-center absolute transition-opacity duration-500 ${error ? "opacity-100" : "opacity-0 pointer-events-none"}`}>
